...
library(readr)
library(leaflet)
# without tmap it throws an error for leaflet; I don't know why
library(tmap)
...
posts <- tidyr::tribble(
  ...
  "Day 63", "Cambodia", "Asia", "[See notes for Cambodia](#cambodia)",
  "Day 62", "Turkmenistan", "Asia", "[See notes for Turkmenistan](#turkmenistan)",
  "Day 61", "Burkina Faso", "Africa", "[See notes for Burkina Faso](#burkina-faso)",
  "Day 60", "Serbia", "Europe", "[See notes for Serbia](#serbia)",
  "Day 59", "São Tomé and Príncipe","Africa", "[See notes for São Tomé and Príncipe](#são-tomé-and-príncipe)",
  "Day 58", "Cameroon", "Africa", "[See notes for Cameroon](#cameroon)",
  "Day 57", "Slovenia", "Europe", "[See notes for Slovenia](#slovenia)",
  "Day 56", "Iran", "Asia", "[See notes for Iran](#iran)",
  "Day 55", "Antigua and Barbuda", "America", "[See notes for Antigua and Barbuda](#antigua-and-barbuda)",
  "Day 54", "Papua New Guinea", "Australia and Oceania", "[See notes for Papua New Guinea](#papua-new-guinea)",
  "Day 53", "Madagascar", "Africa", "[See notes for Madagascar](#madagascar)",
  "Day 52", "Saint Vincent and the Grenadines", "America", "[See notes for Saint Vincent and the Grenadines](#saint-vincent-and-the-grenadines)",
  "Day 51", "Malaysia", "Asia", "[See notes for Malaysia](#malaysia)",
  "Day 50", "Monaco", "Europe", "[See notes for Monaco](#monaco)",
  "Day 49", "Jamaica", "America", "[See notes for Jamaica](#jamaica)",
  "Day 48", "Zambia", "Africa", "[See notes for Zambia](#zambia)",
  "Day 47", "Ireland", "Europe", "[See notes for Ireland](#ireland)",
  "Day 46", "Finland", "Europe", "[See notes for Finland](#finland)",
  "Day 45", "Botswana", "Africa", "[See notes for Botswana](#botswana)",
  "Day 44", "Comoros", "Africa", "[See notes for Comoros](#comoros)",
  "Day 43", "San Marino", "Europe", "[See notes for San Marino](#san-marino)",
  "Day 42", "Sierra Leone", "Africa", "[See notes for Sierra Leone](#sierra-leone)",
  "Day 41", "Tuvalu", "Australia and Oceania", "[See notes for Tuvalu](#tuvalu)",
  "Day 40", "Kiribati", "Australia and Oceania", "[See notes for Kiribati](#kiribati)",
  "Day 39", "Belgium", "Europe", "[See notes for Belgium](#belgium)",
  "Day 38", "New Zealand", "Australia and Oceania", "[See notes for New Zealand](#new-zealand)",
  "Day 37", "Peru", "America", "[See notes for Peru](#peru)",
  "Day 36", "Bahrain", "Asia", "[See notes for Bahrain](#bahrain)",
  "Day 35", "Canada", "America", "[See notes for Canada](#canada)",
  ...
  "Day 23", "Brazil", "America", "[See notes for Brazil](#brazil)",
  ...
  "Day 18", "Guyana", "America", "[See notes for Guyana](#guyana)",
  ...
  "Day 4", "Suriname", "America", "[See notes for Suriname](#suriname)",
...
```{r prepare-map}
create_anchor <- function(country){
  
  country_lower <- tolower(country)
  
  anchor <- stringr::str_replace_all(country_lower, " ", "-")
...
world <- readr::read_rds("world.rds") %>% 
mutate(fill = ifelse(name %in% posts$Country, "darkgreen", "gray"),
       content = case_when(
         name %in% posts$Country ~ paste0("<a href=", "\'#", create_anchor(name), "\'>", name, "</a>"),
         TRUE ~ name))
```
...
Turkmenistan is rich in natural gas. Despite a population of only around 6 million, which is less than 0.1% of the world's population, it has [3.8% of global gas reserves](https://www.worldometers.info/gas/gas-reserves-by-country/). Starting in the early '90s, not long after the country emerged as an independent nation after the collapse of the Soviet Union, its government introduced free electricity, gas, water, and table salt for its citizens. The last item seems rather surprising if we consider that salt is inexpensive, which I assume even most poor people could afford. I wonder if Turkmens consider it a basic necessity, in which case providing it for free sounds like a cheap way for the government to show that it takes care of everything its people need.

Fifteen years later, and under a different leader, another free allowance was introduced. Turkmens became entitled to [120 liters of petrol per month](https://www.bbc.com/news/blogs-news-from-elsewhere-27205105).

But no subsidy can be sustained indefinitely. In 2014, Turkmens had to start paying again for petrol. Three years later, the president [announced plans](https://www.rferl.org/a/turkmenistan-cuts-last-vestiges-of-program-for-free-utilities/29511308.html) to eventually eliminate all free allowances for utilities. To pay for utilities like gas, a gas meter needs to be installed, at a cost of around 60 to 75 dollars. In a country where most people earn low wages (around \$300 a month), this amount is non-trivial. And let's not forget the financial and psychological burden of seeing a monthly bill after almost three decades of free allowances.
...
Among their [notable people](https://en.wikipedia.org/wiki/Mossi_people), we can find musicians, playwrights, journalists, and members of other professions that usually make these lists. Interestingly, though, many of them are soccer players. I wonder if soccer players are indeed more common among the Mossi than elsewhere, or it's just easier to find more information about them.

Certain surnames, especially Ouédraogo, also seem quite common among the famous. Upon inquiry, Ouédraogo must be popular among the famous because it's popular in the general population: 1 in 11 people in the country have this surname, making it the most common Burkinabe [surname](https://forebears.io/burkina-faso/surnames). It comes from the name of the person who founded the Mossi kingdoms. I can see why it's the most popular surname, but the level of its popularity surprised me. For example, in Germany 1 in 85 have the most common [surname](https://forebears.io/germany/surnames); the statistic is similar in [England](https://forebears.io/england/surnames) (1 in 88). Neighboring Mali has a similarly skewed [distribution](https://forebears.io/mali/surnames) as Burkina Faso (1 in 12), while another neighbor, [Ghana](https://forebears.io/ghana/surnames), is closer to the aforementioned European countries (1 in 52).
...
Among the [leading causes of death in Cameroon](https://www.cdc.gov/globalhealth/countries/cameroon/default.htm), we find many medical ones, such as HIV, respiratory infections, malaria, and heart disease. If people were asked to estimate how many deaths were caused by each, we would expect them to underestimate the true numbers. This is not terribly surprising---after all, many of these silent killers are not very salient in the public's mind.
...
Two years earlier, the smaller Lake Monoun also produced a similar explosion, claiming dozens of lives. The disaster was initially [believed to be](https://science.howstuffworks.com/environmental/earth/geophysics/lake-nyos.htm) a terrorist attack or an intentional act of dumping chemicals into the lake.
...
Saint Vincent and the Grenadines is a small island country consisting of the main island (Saint Vincent) and several small islands. There is volcanic activity on Saint Vincent, with La Soufrière being the largest volcano (and also the country's highest point). Its first eruption that was confirmed by observation was in 1718. We have no official records of earlier eruptions, but radioactive dating, a technique used to estimate volcano eruption dates, suggests there had been eruptions [for many thousand years](https://volcano.si.edu/volcano.cfm?vn=360150).

The 1812 eruption inspired English painter J.M.W. Turner. His painting, made three years later, was based on a sketch by a [British plantation owner](https://www.theguardian.com/artanddesign/2021/jan/29/the-great-british-art-tour-liverpool-eruption-of-the-soufriere-mountains-by-jmw-turner) who had been on the island at the time of the eruption. In 1902, the volcano erupted again, claiming about 1700 lives. (In Martinique, a territory in the same Caribbean region, another volcano erupted hours later.)

The latest volcanic activity was in 2020-21. This time, the authorities were prepared, and an evacuation plan was in place. About 20,000 people had to be evacuated. The [World Bank provided financing](https://www.worldbank.org/en/news/press-release/2021/11/30/saint-vincent-and-the-grenadines-to-receive-us-40-million-from-the-world-bank) to the country to help with the post-eruption recovery.
...
In the 1970s, the government began to nationalize the formerly private mines. Production declined in the next two decades to a low of about [250,000 at the turn of the millennium](https://miningforzambia.com/zambias-history-of-copper-production-part-1/). Then the government decided to privatize the mines again. Foreign private investment poured in, production increased, and new mines were opened.

Today, four mines account for about 80% of Zambia's entire production. [Two of them](https://miningforzambia.com/a-concentrated-mining-sector/) are not in the Copperbelt but in the adjacent, previously underdeveloped North-Western province. In 2020, the country's copper production reached 880,000 tons, a [historic high](https://www.reuters.com/article/uk-zambia-copper-idUSKBN2AN0NL). Last year, the government [nationalized one of Zambia's largest mines](https://www.dw.com/en/nationalizing-zambias-copper-mines/a-56843152), which may be a precursor of further similar moves.
...
Currently, the largest mining company in the country is Debswana, a joint venture between the government and De Beers, a large international mining company. Starting its operations in 1969, it now mines diamonds in four different locations and is the largest private-sector employer in the country. Its largest mine, Jwaneng Mine, contributes about [60-70%](http://www.debswana.com/Operations/Pages/Jwaneng-Mine.aspx) of the company's revenues.
...
Essential oils, for instance, mainly refer to the oil extracted from the ylang-ylang plant, a tropical tree with yellow flowers. After an early-morning harvest, the flowers are quickly taken to a local distillery to extract oil from them. To extract 2 liters of oil, approximately [100kg of flowers](https://materiaaromatica.com/oil-profiles/ylang-ylang-oil) are needed. The next step is exporting the oil, primarily to France, where it serves as the main ingredient of high-quality perfumes, including the famous CHANEL N°5.

The other two products---vanilla and cloves---also come from plants. Vanilla is among the most expensive spices because it's very labor-intensive: the vanilla orchards must be [pollinated by hand](https://88acres.com/blogs/news/all-about-vanilla), and when it's harvest time, the beans are also hand-picked.
...
Among other things, the conflict left 50,000 dead, many were internally and externally displaced, and there was significant damage to the country's infrastructure. In a particularly gruesome attack in Freetown, the capital, rebel forces maimed, raped, and murdered thousands of civilians [indiscriminately](https://www.hrw.org/news/1999/06/24/shocking-war-crimes-sierra-leone).
...
Before potatoes were introduced, the Māori produced a type of sweet potato that they had brought with them from Polynesia. Potatoes brought by the settlers were better suited to New Zealand's [cooler climate](https://www.sciencelearn.org.nz/resources/783-the-cultural-value-of-taewa-maori-potatoes), quickly overtaking the sweet potato as a staple food. This agricultural improvement benefitted the local populace---unlike muskets.
...
When the parties first raised the idea, Bahrainis were driving on the left and Saudi Arabians on the right. In 1967, Bahrain switched over to right-hand traffic (around that time, many other countries [were doing the same](https://www.wsj.com/articles/a-brief-history-of-driving-on-the-left-1506088964)), having to worry about one fewer thing in the already challenging engineering project.
...
Currently, around 20% of Canada's population are immigrants. With current yearly targets of approximately [400,000 immigrants](https://www.canada.ca/en/immigration-refugees-citizenship/news/notices/supplementary-immigration-levels-2021-2023.html), Canada's immigrant population is likely to grow even further in the future.
